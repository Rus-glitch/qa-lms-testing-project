...
### 1. Просмотр всех курсов
- [TC-CC-001 – Просмотр курсов в каталоге (отображение карточек)](#tc-cc-001)
- [TC-CC-002 – Отображение заглушки при отсутствии курсов](#tc-cc-002)
- [TC-CC-003 – Отсутствие изображения курса (placeholder)](#tc-cc-003)
- [TC-CC-004 – Рейтинг выше 5 звёзд](#tc-cc-004)

### 2. Фильтрация по категориям
- [TC-CC-005 – Фильтрация по категориям](#tc-cc-005)
- [TC-CC-006 – Фильтрация: все чекбоксы отключены](#tc-cc-006)
- [TC-CC-007 – Фильтрация: отсутствуют курсы в выбранной категории](#tc-cc-007)

### 3. Поиск по названию курса
- [TC-CC-008 – Поиск по полному названию курса](#tc-cc-008)
- [TC-CC-009 – Поиск по частичному названию курса](#tc-cc-009)
- [TC-CC-010 – Поиск с разным регистром букв](#tc-cc-010)
- [TC-CC-011 – Поиск с лишними пробелами](#tc-cc-011)
- [TC-CC-012 – Поиск по несуществующему имени](#tc-cc-012)
- [TC-CC-013 – Поиск с пустым полем](#tc-cc-013)
- [TC-CC-014 – SQL-инъекция в поле поиска](#tc-cc-014)
- [TC-CC-015 – XSS-инъекция в поле поиска](#tc-cc-015)

### 4. Сортировка курсов
- [TC-CC-016 – Сортировка по всем параметрам](#tc-cc-016)
- [TC-CC-017 – Сортировка по популярности](#tc-cc-017)
- [TC-CC-018 – Сортировка по рейтингу](#tc-cc-018)
- [TC-CC-019 – Сортировка по новизне](#tc-cc-019)
- [TC-CC-020 – Сортировка: нет подходящих курсов](#tc-cc-020)
- [TC-CC-021 – Сортировка с невалидным параметром](#tc-cc-021)

### 5. Пагинация
- [TC-CC-022 – Проверка работы пагинации](#tc-cc-022)
- [TC-CC-023 – Пагинация: невалидное значение страницы в URL](#tc-cc-023)
- [TC-CC-024 – Пагинация: выход за пределы существующих страниц](#tc-cc-024)
